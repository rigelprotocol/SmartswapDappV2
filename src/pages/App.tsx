        ...
        <Switch>
          ...
          <ErrorBoundary>
            <Switch>
              ...
              <Route exact strict path="/freeswap/:router" component={chainId === SupportedChainId.BINANCETEST || chainId === SupportedChainId.BINANCE || chainId === SupportedChainId.POLYGON || chainId===undefined  ? InstantSwap : Swap } />
