  ...
  return(
    <Center m={8}>
      ...
      >
        ...
        <Box borderRadius="md" borderWidth="1px" pt={2} pb={2} borderColor={genBorder}>
          <InputSelector max />
        </Box>
        <Flex justifyContent="center">
          <Center w="40px" h="40px" bg={bgColor} borderWidth="3px" borderColor={genBorder} color="#333333" borderRadius="xl" mt={5} mb={5}>
            <AddIcon color={textColorOne}/>
          </Center>
        </Flex>
        <Box borderRadius="md" border="1px solid #DEE6ED" pt={2} pb={2} borderColor={genBorder}>
        ...
        <Box
          ...
          mb="3"
        >
          <Text p="4" fontWeight="400">Prices & pool share</Text>
